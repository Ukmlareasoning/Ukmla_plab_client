...
function AdminAddUser() {
  ...
  // Profile (basic information + photo) – mirrored from Settings.jsx
  ...
  // Change password – mirrored from Settings.jsx
  ...
  // Change email – mirrored from Settings.jsx
  ...
  // Fetch current admin profile, same pattern as Settings.jsx
  useEffect(() => {
    let cancelled = false
    ...
    try {
      ...
      if (!ok || !data?.success) {
        ...
        if (errors.current_password) {
          const msg = Array.isArray(errors.current_password)
    ...
    >
      ...
      <Paper
        ...
        sx={{
          ...
          boxShadow: {
            xs: `0 2px 12px ${alpha(ADMIN_PRIMARY, 0.06)}`,
            sm: `0 4px 20px ${alpha(ADMIN_PRIMARY, 0.04)}`,
          },
          mb: { xs: 3, sm: 4 },
        }}
      >
            ...
            <Grid container spacing={{ xs: 2, sm: 2, md: 2 }} alignItems="flex-start">
                ...
                <TextField
                  ...
                  onClick={() => {
                    if (changeEmailRef.current) {
                      changeEmailRef.current.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start',
                      })
                    }
              ...
              >
                ...
                >
                  ...
                  >
                    <InputLabel id="admin-settings-gender-label" shrink>
                      Gender
                    </InputLabel>
                    <Select
                      labelId="admin-settings-gender-label"
                      value={gender}
                      label="Gender"
                    ...
                    {genderError && (
                      <FormHelperText sx={{ color: 'error.main' }}>{genderError}</FormHelperText>
                    )}
                  </FormControl>
                </Box>
              </Grid>
        ...
        <Box sx={{ mb: { xs: 3, sm: 4 } }}>
          ...
          >
            ...
            >
              <AccountCircleRoundedIcon
                sx={{ color: ADMIN_PRIMARY, fontSize: { xs: 22, sm: 24 } }}
              />
            </Box>
            <Box sx={{ minWidth: 0 }}>
              <Typography
          ...
          <Box
            sx={{
              ...
              border: `1px dashed ${
                profileImageError ? theme.palette.error.main : alpha(ADMIN_PRIMARY, 0.2)
              }`,
            }}
          >
            {/* Preview area */}
              ...
              >
                {profilePreview ? (
                  ...
                  <AddPhotoAlternateRoundedIcon
                    sx={{ color: theme.palette.grey[400], fontSize: 48 }}
                  />
                )}
              </Box>
            </Box>
            ...
            >
              ...
              >
                <Button
                  ...
                  size="small"
                  startIcon={
                    <AddPhotoAlternateRoundedIcon sx={{ fontSize: { xs: 18, sm: 20 } }} />
                  }
                  sx={{
                    borderRadius: '7px',
                    fontWeight: 600,
        ...
        {/* Actions: Back + Update profile */}
        <Box sx={{ display: 'flex', justifyContent: 'space-between', pt: { xs: 1.5, sm: 2 } }}>
          <Button
            type="button"
            variant="outlined"
            size="large"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <LockResetIcon sx={{ color: ADMIN_PRIMARY, fontSize: { xs: 22, sm: 24 } }} />
            </Box>
            <Box sx={{ minWidth: 0 }}>
              <Typography
                variant="h6"
        ...
        >
          ...
          {!otpSent ? (
            ...
            >
              ...
              >
                We've sent a 6-digit code to <strong>{emailPendingVerification}</strong>. Enter it
                below.
              </Typography>
              <TextField
                fullWidth
