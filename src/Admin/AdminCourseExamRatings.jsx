...
// Mock: ~10 rating records for this mock exam (replace with API later)
const MOCK_RATINGS = [
  { id: 1, fullName: 'Dr. Sarah Mitchell', profileImage: 'https://i.pravatar.cc/100?img=1', stars: 5, comment: 'Excellent mock exam. Very relevant to UKMLA and the feedback was clear.' },
  ...
  { id: 3, fullName: 'Dr. Emma Watson', profileImage: 'https://i.pravatar.cc/100?img=3', stars: 5, comment: 'Best mock pack I have used. Structure mirrors the real exam.' },
  ...
  { id: 8, fullName: 'Noah Wilson', profileImage: 'https://i.pravatar.cc/100?img=8', stars: 4, comment: 'Solid content. Would be great to have more ethics questions.' },
  ...
  { id: 10, fullName: 'Ethan Davis', profileImage: 'https://i.pravatar.cc/100?img=10', stars: 4, comment: 'Good value. The timed conditions kept me focused.' },
]

function AdminCourseExamRatings() {
  ...
  const handleBack = () => {
    navigate('/admin/courses/lectures', { state: courseTitle ? { courseTitle } : undefined })
  }
  ...
  return (
    ...
    >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25, mb: 0.25 }}>
          ...
          <Box sx={{ minWidth: 0 }}>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', mt: 0.25 }}>
              {courseTitle ? `${courseTitle} · ` : ''}All ratings for this mock exam
            </Typography>
          </Box>
        </Box>
      </Box>
      ...
      {/* Pagination — same style as admin lists */}
      <Box
        sx={{
          display: 'flex',
          flexDirection: { xs: 'column', sm: 'row' },
...
export default AdminCourseExamRatings
