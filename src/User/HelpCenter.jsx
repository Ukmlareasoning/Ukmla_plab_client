...
const PAGE_TYPE_HELP_CENTER = 'Help Center'

// Icons from static_pages table: each row's icon_key (e.g. "helpCenter" for Help Center) maps here
...
const defaultHeroTitle = 'Help Center'
const defaultHeroSubtitle = 'Find answers, get started, and reach support for UKMLA and PLAB 1 preparation.'
...
function HelpCenter() {
  ...
  useEffect(() => {
    ...
    async function fetchHelpCenter() {
      ...
      params.set('page_type', PAGE_TYPE_HELP_CENTER)
      params.set('active', '1')
                ...
                : pages.length === 0 ? (
                    <Box sx={{ textAlign: 'center', py: 6 }}>
                      <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                        No help content to show yet. Content will appear here once added in the admin.
                      </Typography>
                    </Box>
                  ) : (
